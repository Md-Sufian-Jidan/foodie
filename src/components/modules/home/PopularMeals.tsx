...
export function PopularMeals({ meals }: ProviderMealsGridProps) {
    ...
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="mb-8">
                <h2 className="text-3xl font-bold mb-2">Popular Meals</h2>
                <p className="text-muted-foreground">
            ...
            <div className="mt-8 flex">
                <Link href="/meals" className="self-center text-center mt-4 w-full">
                    <Badge className="px-4 py-2 bg-primary/10 text-primary font-medium rounded-md hover:bg-primary/20 transition-colors">
                        View All Meals
                    </Badge>
                </Link>
            </div>
