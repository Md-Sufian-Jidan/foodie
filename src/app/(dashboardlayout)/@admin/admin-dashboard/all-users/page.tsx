...
export default function UsersPage() {
    ...
    useEffect(() => {
        async function fetchUsers() {
            ...
            setUsers(data || [
                { id: "1", name: "Sarah Jenkins", email: "sarah@example.com", role: "CUSTOMER", isActive: true, image: "" },
                { id: "2", name: "Chef Roberto", email: "roberto@kitchen.com", role: "PROVIDER", isActive: true, image: "" },
                { id: "3", name: "Mark Sloan", email: "mark.s@example.com", role: "CUSTOMER", isActive: false, image: "" },
            ]);
        }
        fetchUsers();
    }, []);
                                ...
                                <TableRow key={user.id} className="border-b border-[#6B7280]/5 hover:bg-[#FAF9F7]/30 dark:hover:bg-[#121110]/30 transition-colors">
                                    ...
                                    <TableCell className="py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className={`text-xs font-bold ${user.isActive ? 'text-emerald-600' : 'text-red-600'}`}>
